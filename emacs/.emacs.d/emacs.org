...
* Settings for macOS
  ...
  #+begin_src emacs-lisp :tangle no :noweb-ref mac-specific-code
    ...
    (use-package exec-path-from-shell :straigt t)
...
* User Interface
  ...
  #+begin_src emacs-lisp
    ;(use-package powerline :straigt t)
    ;(use-package spaceline :straigt t)
...
** Focus Mode
   ...
   #+begin_src emacs-lisp
     (use-package olivetti :straigt t)
     (use-package hide-mode-line :straigt t)
   #+end_src
...
* Org Mode
  ...
  #+begin_src emacs-lisp
  ;;(use-package org-plus-contrib :straigt t)
  #+end_src
...
*** \LaTeX export
    ...
    {{{package(ox-extra)}}}
    #+begin_src emacs-lisp
      (use-package ob-mermaid :straigt t)
	...
	(if mmdc-binary
      ...
      (use-package plantuml-mode :straigt t)
...
*** Projectile
  ...
  #+begin_src emacs-lisp
    (use-package projectile :straigt t)
